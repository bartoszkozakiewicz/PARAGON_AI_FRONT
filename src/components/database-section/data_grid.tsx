                ...
                <DataGrid
                  ...
                  onRowClick = {(params)=>{
                    ...
                    if (rowData.category === "Shopping"){
                      ...
                      router.push(`/edit-single-paragon?shopId=${rowData.realId}&&shopName=${rowData.name}&&shopDate=${rowData.date}`)//? =${rowData.realId}&&shopName=${rowData.name}&&shopDate=${rowData.date}
                    }
                  }}
                  initialState={{
                    pagination: {
